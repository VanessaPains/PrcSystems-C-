    ...
    public class PessoaController
    {
        ...
        public int Inserir(Pessoa obj)
        {
            using (SqlConnection con = new SqlConnection())
            {
                ...
                con.Open();
                cn.CommandText = "INSERT INTO Pessoa ([TipoCadastro], [TipoPessoa], [CnpjCpf], [RazaoNome], [Fantasia], [InscEstadual], [OutrasInsc], [Endereco], [Num], [Complemento], [Cep],[Bairro],[Cidade],[Uf],[Telefone],[Celular],[Email],[Site],[EnderecoCob],[NumCob],[ComplementoCob],[CepCob],[BairroCob],[CidadeCob],[UfCob],[Observacao],[DtCadPessoa]) VALUES " +
                "(@TipoCadastro, @TipoPessoa, @CnpjCpf, @RazaoNome, @Fantasia, @InscEstadual, @OutrasInsc, @Endereco, @Num, @Complemento, @Cep, @Bairro, @Cidade, @Uf, @Telefone, @Celular, @Email, @Site, @EnderecoCob, @NumCob, @ComplementoCob, @CepCob, @BairroCob, @CidadeCob, @UfCob, @Observacao, @DtCadPessoa)";
        ...
        public List<Pessoa> PesquisaRazaoNomeCliForn(Pessoa obj)
        {
            using (SqlConnection con = new SqlConnection())
            {
                ...
                cn.CommandType = CommandType.Text;
                con.Open();
                cn.CommandText = "SELECT * FROM Pessoa WHERE RazaoNome = @RazaoNome";
