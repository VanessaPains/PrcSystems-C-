...
namespace prcSystem.View
{
    public partial class FormCadLancExcluir : Form
    {
        ...
        public void PesquisarNumDocCnpjCpfCodCdcRazaoNome()
        {
            ...
            obj.NumDocumento = Convert.ToString(txtPesquisaLancmentos.Text);
            obj.CodCdc = Convert.ToString(txtPesquisaLancmentos.Text);
            obj.RazaoNome = Convert.ToString(txtPesquisaLancmentos.Text);
            obj.CnpjCpf = Convert.ToString(txtPesquisaLancmentos.Text);
        ...
        private void txtPesquisaLancmentos_TextChanged(object sender, EventArgs e)
        {
